...
# POWERLEVEL10K
source /home/uvax/powerlevel10k/powerlevel10k.zsh-theme
...
export PATH=/home/uvax/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:/opt/nvim/bin

# Solved Terminal issues with SSH
